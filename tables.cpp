...
{ 	"unknown", "Moc",   "Umiejêtno¶æ", "Broni", "Jêzyk",  "Herb" 	};
...
const	struct	fun_type		fun_table	[ ] =
{
    ...
    {	"do_cset",			do_cset			},
    {	"do_clear_modules",		do_clear_modules	},//Qrwa maæ !!!
    	    /*
	     * Uuu, Alde. To 'Qrwa maæ' te¿ u nas koduje? :P
    ...
    {	"do_detrap",			do_detrap		},
	{	"do_dialedit",			do_dialedit		},	//Tanglor - Edytor Dialogów
	{	"do_diallist",			do_diallist		},	//Tanglor - Lista dialogów
    {	"do_dig",			do_dig			},
    {	"do_disarm",			do_disarm		},
...
//    {	"do_makewizlist",		do_makewizlist		},
    ...
    /* !!! NIE DOTYKAÆ - TO MA BYÆ NA KOÑCU !!! */
